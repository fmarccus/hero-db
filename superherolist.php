...
<body>
    ...
    <div class="container">
        <p class="is-size-2 has-text-light mt-5 mb-5">Character List</p>
    
        <section id="datatable">
            <table class="table has-text-white has-text-centered has-background-dark is-fullwidth" id="myTable">
                <thead>
                    <tr>
                        <th class="has-text-light has-text-centered">ID#</th>
                        <th class="has-text-light has-text-centered">Character Name</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>

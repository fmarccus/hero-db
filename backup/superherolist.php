...
<body class="bg-dark">
    ...
    <div class="container">
        <section class="text-white">
            <h1 class="mt-5">Character List</h1>
            <form method="post" action="superherodata.php">
                <div class="mb-3">
                    <center>
                        <input type="text" class="form-control w-25 py-3 fw-bold" name="characterid" id="" placeholder="Enter the ID of the character">
                        <button class="btn btn-outline-light fw-bold px-5 py-2 rounded-4 mt-3" type="submit"> see character data</button>
                    </center>
                </div>
            </form>
            <table class="table text-light text-center table-bordered" id="myTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>125</td>
                        <td>Blue Beetle II</td>
                    </tr>
                    <tr>
                        <td>126</td>
                        <td>Blue Beetle III</td>
                    </tr>
                    <tr>
                        <td>127</td>
                        <td>Boba Fett</td>
